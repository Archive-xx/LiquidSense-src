...
public final class IntrinsicsKt__IntrinsicsJvmKt$createCoroutineUnintercepted$$inlined$createCoroutineFromSuspendFunction$IntrinsicsKt__IntrinsicsJvmKt$1 extends RestrictedContinuationImpl {
   ...
   public IntrinsicsKt__IntrinsicsJvmKt$createCoroutineUnintercepted$$inlined$createCoroutineFromSuspendFunction$IntrinsicsKt__IntrinsicsJvmKt$1(Continuation $captured_local_variable$1, Continuation $super_call_param$2, Function1 var3) {
   ...
   protected Object invokeSuspend(@NotNull Object result) {
      ...
      case 0:
         ...
         int var5 = false;
         Function1 var6 = this.$this_createCoroutineUnintercepted$inlined;
         if (var6 == null) {
            throw new TypeCastException("null cannot be cast to non-null type (kotlin.coroutines.Continuation<T>) -> kotlin.Any?");
         }

         var10000 = ((Function1)TypeIntrinsics.beforeCheckcastToFunctionOfArity(var6, 1)).invoke(it);
         break;
      case 1:
         this.label = 2;
         var3 = false;
