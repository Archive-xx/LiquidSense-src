...
class IntrinsicsKt__IntrinsicsKt extends IntrinsicsKt__IntrinsicsJvmKt {
   ...
   @InlineOnly
   private static final <T> Object suspendCoroutineOrReturn(Function1<? super Continuation<? super T>, ? extends Object> block, Continuation<? super T> var1) {
      int $i$f$suspendCoroutineOrReturn = 0;
      InlineMarker.mark(0);
      int var4 = false;
      Continuation var7 = CoroutineIntrinsics.normalizeContinuation(var1);
      Object var10000 = block.invoke(var7);
      InlineMarker.mark(1);
      return var10000;
   }
   ...
   @InlineOnly
   private static final <T> Object suspendCoroutineUninterceptedOrReturn(Function1<? super Continuation<? super T>, ? extends Object> block, Continuation<? super T> var1) {
