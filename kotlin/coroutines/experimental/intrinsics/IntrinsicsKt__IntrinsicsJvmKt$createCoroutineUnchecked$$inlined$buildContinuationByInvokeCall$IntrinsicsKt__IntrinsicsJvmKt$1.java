...
public final class IntrinsicsKt__IntrinsicsJvmKt$createCoroutineUnchecked$$inlined$buildContinuationByInvokeCall$IntrinsicsKt__IntrinsicsJvmKt$1 implements Continuation<Unit> {
   ...
   public IntrinsicsKt__IntrinsicsJvmKt$createCoroutineUnchecked$$inlined$buildContinuationByInvokeCall$IntrinsicsKt__IntrinsicsJvmKt$1(Continuation $captured_local_variable$0, Function1 var2, Continuation var3) {
   ...
   public void resume(@NotNull Unit value) {
      ...
      try {
         int var4 = false;
         Function1 var10000 = this.$this_createCoroutineUnchecked$inlined;
         if (var10000 == null) {
            throw new TypeCastException("null cannot be cast to non-null type (kotlin.coroutines.experimental.Continuation<T>) -> kotlin.Any?");
         }

         Object var6 = ((Function1)TypeIntrinsics.beforeCheckcastToFunctionOfArity(var10000, 1)).invoke(this.$completion$inlined);
