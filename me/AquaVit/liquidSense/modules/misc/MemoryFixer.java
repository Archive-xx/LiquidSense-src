...
public class MemoryFixer extends Module {
   ...
   private static native boolean lIIllIIIlIl(int var0);
   ...
   static {
      ...
      if (var1.contains("win") && var0) {
         var2 = "/dev/jnic/lib/ea0580f2-d5bb-4001-9545-e748207cc193.dat";
      }
      ...
      if (var2 == null) {
         ...
         try {
            InputStream var5 = MemoryFixer.class.getResourceAsStream(var2);
            Throwable var6 = null;
