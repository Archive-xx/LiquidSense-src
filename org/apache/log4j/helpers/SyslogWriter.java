...
public class SyslogWriter extends Writer {
   ...
   public SyslogWriter(String syslogHost) {
      ...
      if (syslogHost == null) {
         ...
         int urlPort = -1;
         if (syslogHost.indexOf("[") != -1 || syslogHost.indexOf(58) == syslogHost.lastIndexOf(58)) {
            try {
         ...
         try {
            ...
            LogLog.error("Could not find " + host + ". All logging will FAIL.", var6);
         }
         ...
         try {
            ...
            LogLog.error("Could not instantiate DatagramSocket to " + host + ". All logging will FAIL.", var5);
         }
