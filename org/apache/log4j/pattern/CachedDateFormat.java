      ...
      if (plusMagic.length() != formatted.length()) {
         ...
         for(int i = 0; i < formatted.length(); ++i) {
            if (formatted.charAt(i) != plusMagic.charAt(i)) {
               ...
               if (plusZero.length() == formatted.length() && magicString.regionMatches(0, plusMagic, i, magicString.length()) && formattedMillis.toString().regionMatches(0, formatted, i, magicString.length()) && "000".regionMatches(0, plusZero, i, 3)) {
                  return i;
               }
