...
public final class NativeUint8Array extends ArrayBufferView {
   ...
   private static final class Uint8ArrayData extends TypedArrayData<ByteBuffer> {
      ...
      // $FF: synthetic method
      Uint8ArrayData(ByteBuffer x0, int x1, int x2, Object x3) {
         this(x0, x1, x2);
      }

      static {
         GET_ELEM = CompilerConstants.specialCall(MethodHandles.lookup(), NativeUint8Array.Uint8ArrayData.class, "getElem", Integer.TYPE, Integer.TYPE).methodHandle();
         SET_ELEM = CompilerConstants.specialCall(MethodHandles.lookup(), NativeUint8Array.Uint8ArrayData.class, "setElem", Void.TYPE, Integer.TYPE, Integer.TYPE).methodHandle();
      }
   }
}
