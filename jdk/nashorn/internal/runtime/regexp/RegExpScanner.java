...
final class RegExpScanner extends Scanner {
   ...
   private final List<RegExpScanner.Capture> caps = new LinkedList();
   ...
   private void processForwardReferences() {
      Iterator iterator = this.forwardReferences.descendingIterator();
   ...
   BitVector getGroupsInNegativeLookahead() {
      ...
      for(int i = 0; i < this.caps.size(); ++i) {
         RegExpScanner.Capture cap = (RegExpScanner.Capture)this.caps.get(i);
         ...
         if (this.characterClass()) {
            ...
            if (this.ch0 == '(') {
               ...
               if (this.ch0 == '?' && this.ch1 == ':') {
                  ...
                  this.caps.add(new RegExpScanner.Capture(this.negLookaheadGroup, this.negLookaheadLevel));
               }
      ...
      if (this.ch0 == '0' && !isOctalDigit(this.ch1)) {
         ...
         if (this.ch0 == '0') {
            ...
            if (this.inCharClass) {
               ...
               RegExpScanner.Capture capture = (RegExpScanner.Capture)this.caps.get(decimalValue - 1);
