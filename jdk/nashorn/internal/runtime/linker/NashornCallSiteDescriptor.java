...
public final class NashornCallSiteDescriptor extends AbstractCallSiteDescriptor {
   ...
   public static NashornCallSiteDescriptor get(Lookup lookup, String name, MethodType methodType, int flags) {
   ...
   private static NashornCallSiteDescriptor get(Lookup lookup, String operator, String operand, MethodType methodType, int flags) {
   ...
   private NashornCallSiteDescriptor(Lookup lookup, String operator, String operand, MethodType methodType, int flags) {
      this.lookup = lookup;
