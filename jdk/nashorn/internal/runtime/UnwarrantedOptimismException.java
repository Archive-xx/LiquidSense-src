...
public final class UnwarrantedOptimismException extends RuntimeException {
   ...
   public UnwarrantedOptimismException(Object returnValue, int programPoint, Type returnType) {
      super("", (Throwable)null, false, Context.DEBUG);
   ...
   public static UnwarrantedOptimismException createNarrowest(Object returnValue, int programPoint) {
      return !(returnValue instanceof Float) && (!(returnValue instanceof Long) || !JSType.isRepresentableAsDouble((Long)returnValue)) ? new UnwarrantedOptimismException(returnValue, programPoint) : new UnwarrantedOptimismException(((Number)returnValue).doubleValue(), programPoint, Type.NUMBER);
   }
